...
public class ChallengeManager : MonoBehaviour
{
    ...
    [SerializeField] public Challenge actualChallenge;
    [SerializeField] public bool hasActiveChallenge;
    [SerializeField] public int difficulty;
    [SerializeField] private TMP_Text introductionUI;
    [SerializeField] private MenuManager menuManager;
    [SerializeField] private InventoryManager inventoryManager;
    [SerializeField] private bool hasAllElementsForChallenge;
    [SerializeField] private Sprite[] moleculeGeometrySprites;
    ...
    public void answerGeometryQuestion(int geometrySelected)
    {
        ...
        {
            menuManager.answerGeometryQuestion(actualChallenge.moleculeGeometryFeedbacks[geometrySelected - 1], true);
        }
        else
        {
            menuManager.answerGeometryQuestion(actualChallenge.moleculeGeometryFeedbacks[geometrySelected - 1], false);
        }
    }
    ...
    public void elementAddedToInventory()
    {
        ...
        {
            if (actualChallenge.necessaryElements.Contains(unlockedElement)) unlockedElementForChallengeTotal++;
        }
        menuManager.updateScoreText(unlockedElementForChallengeTotal + "/" + actualChallenge.necessaryElements.Length);
    ...
    public void StartChallenge(int difficulty)
    {
        ...
        menuManager.updateQuestionText(actualChallenge.question, actualChallenge.optionA, actualChallenge.optionB, actualChallenge.optionC);
        menuManager.updateGeometryOptionImage(actualChallenge.moleculeGeometryOptionA, actualChallenge.moleculeGeometryOptionB, actualChallenge.moleculeGeometryOptionC);
